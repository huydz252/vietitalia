...
export default function Ambassador(container) {
  container.innerHTML =
    // ---------------- BANNER ----------------
    `<section class="bg-primary text-white pt-20 pb-16 md:pt-24">
    ...
    <section class="bg-surface-container-low py-10 md:py-14">
      <div class="max-w-container-max mx-auto px-margin-mobile xl:px-margin-desktop">
        <img src="/images/italy/View-from-Campanile-Florence.jpg" alt="Chương trình Đại Sứ Văn Hóa VietItalia 2026"
          class="w-full h-auto max-h-[520px] object-cover rounded-2xl institutional-shadow"> <!-- ẢNH: banner chính của bạn -->
      </div>
    </section>` +
    ...
    `<section class="italy-accent bg-surface-container-low py-16">
      <div class="max-w-container-max mx-auto px-margin-mobile xl:px-margin-desktop">
        ...
        <p class="mt-8 text-center font-headline-sm text-headline-sm">Không chỉ đến Ý để tham quan, mà đến để học hỏi, kết nối và tạo giá trị sau chuyến đi. 🇮🇹🤝🇻🇳</p>
      </div>
    </section>`;
}