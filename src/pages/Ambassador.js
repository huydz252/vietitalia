    ...
    <section class="banner-image bg-cover text-white py-20"
      style="
        ...
        background-image:
          ...
          url('src/assets/images/italy/View-from-Campanile-Florence.jpg');
      "
    >
      <div class="max-w-container-max mx-auto px-margin-mobile xl:px-margin-desktop">
        ...
        <h1 class="font-display-lg text-display-lg mt-3">
          Đại Sứ Văn Hóa Việt Ý
        </h1>

        <p class="italic">
          Ambasciatori culturali Vietnam – Italia
        </p>
      </div>
    </section>
  `;
  ...
  s.innerHTML =
    `
      <div class="grid lg:grid-cols-2 gap-10">
        <form
          class="bg-surface-container-low p-7 grid gap-4"
          novalidate
        >
          ...
          <button class="bg-primary text-white py-3">
            Gửi đăng ký
          </button>
    ...
    [
      ...
      .map(
        ([number, title]) => `
          <div class="vietnam-accent bg-surface-container-low p-5">
            <p class="text-3xl font-headline-md text-primary">
              ${number}
            </p>
    ...
    projects
      .map(
        (project) => `
          <article class="italy-accent bg-white institutional-shadow p-6">
            <span class="material-symbols-outlined text-secondary">
              diversity_3
            </span>

            <h3 class="font-headline-sm text-headline-sm mt-4">
              ${project}
            </h3>

            <p class="text-sm mt-2 text-on-surface-variant">
              Kết nối sáng kiến địa phương với những người bạn Ý và Việt Nam.
            </p>
          </article>
        `,
      )
    ...
    `
      ...
      <div class="grid md:grid-cols-2 gap-6 mt-14">
        <article class="p-6 bg-surface-container-low">
          <h3 class="font-headline-sm text-headline-sm">
            Cultural Ambassador
          </h3>

          <p class="mt-3 italic">
            “Tôi tìm thấy cộng đồng cùng gìn giữ những câu chuyện đẹp.”
          </p>
        </article>
        ...
        <article class="p-6 bg-surface-container-low">
          ...
          <p class="mt-3 italic">
            “Mỗi kết nối đúng lúc có thể tạo nên một dự án bền vững.”
          </p>
        </article>
      </div>

      <div class="grid md:grid-cols-2 gap-8 mt-14 items-center">
        <div class="h-52 media-cover grid place-items-center text-white text-center font-headline-sm">
          VIETITALIA
          <br>
        ...
        <div>
          <h2 class="font-headline-sm text-headline-sm">
            Chứng nhận VietItalia
          </h2>

          <p class="mt-3 text-on-surface-variant">
            Sau khi hoàn thành hành trình đào tạo và đóng góp dự án,
            đại sứ được ghi nhận bằng chứng nhận của VietItalia Bridge.
          </p>
        </div>
      </div>
    `;
