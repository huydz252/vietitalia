...
export default function VietnamMarket(container) {
  container.innerHTML = `
    <section class="banner-image bg-cover text-white py-20"
      style="
        ...
        background-image:
          ...
          url('src/assets/images/vietnam/image.jpg');
      "
    >
            ...
            (item) => `
              <article class="vietnam-accent bg-surface-container-low p-6">
                ...
                <p class="mt-2 text-sm text-on-surface-variant">
                  Tiềm năng hợp tác dài hạn tại Việt Nam.
                </p>
              </article>
            `,
          )
    ...
    <section class="bg-primary text-white text-center p-12">
      ...
      <a
        data-link
        href="/business-matching?from=italy-business"
        class="inline-block mt-6 bg-white text-primary px-6 py-3 font-semibold">
        Đăng nhu cầu tìm đối tác Việt Nam
      </a>
    </section>
  `;
}